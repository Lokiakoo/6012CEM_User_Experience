...
document.addEventListener('DOMContentLoaded', () => {
  generateMovieCards(moviesData.type3, 'div-one-container');
  generateMovieCards(moviesData.type4, 'div-two-container');
  generateMovieCards(moviesData.type1, 'div-three-container');
  generateMovieCards(moviesData.type2, 'div-four-container');
  generateMovieCards(moviesData.type3, 'div-five-container');
});
